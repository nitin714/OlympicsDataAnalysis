...
if user_menu == 'Overall Analysis':
  ...
  if len(helper.most_successful(df,selected_sport)):
...
if user_menu == 'Country-wise Analysis':
  ...
  if len(helper.yearwise_medal_tally(df,selected_country)):
  ...
  if len(helper.country_event_heatmap(df,selected_country)):
  ...
  if len(helper.most_successful_countrywise(df,selected_country))!=0:
